...
gsap.to("#smile", {x: 130, y: -200, duration: 3, delay: 7, ease: "elastic", rotation: 360, opacity: 1})

gsap.from(".question", {x: 1000, y: 200, delay: 7})
gsap.to(".question", {x: 630, y: 200, duration: 3, ease: "power1", opacity: 1, delay: 7})

gsap.from(".yes-btn", {x: 600, y: 1000, opacity: 0, delay: 8})
gsap.to(".yes-btn", {x: 600, y: 250, duration: 3, ease: "power1", opacity: 1, delay: 8})

gsap.from(".no-btn", {x: 700, y: 1000, opacity: 0, delay: 8})
gsap.to(".no-btn", {x: 700, y: 250, duration: 3, ease: "power1", opacity: 1, delay: 8})
