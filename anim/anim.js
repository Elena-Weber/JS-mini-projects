...
gsap.to(".second", {x: 200, duration: 3, delay: 4, ease: "power2", opacity: 1})

gsap.to(".third", {x: 250, duration: 3, delay: 5, ease: "power3", opacity: 1})

gsap.to(".fourth", {x: 300, duration: 3, delay: 6, ease: "power4", opacity: 1})
